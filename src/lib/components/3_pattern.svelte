<script>
    ...
    let offset = $state(0);
    let hue = $state(120);
    let color1 = $derived(chroma.oklch(0.3, 0.2, hue));
    let color2 = $derived(chroma.oklch(0.4, 0.2, hue + 100));
    let color3 = $derived(chroma.oklch(0.5, 0.2, hue + 200));
    let color4 = $derived(chroma.oklch(0.6, 0.2, hue));
